        ...
        <div style={s.sectionInner}>
          ...
          <div style={s.originBlock}>
            <p style={s.originText}>
              2025 年，上海时间银行宣布暂停运营。数万名用户积累多年的时间积分面临清零风险——
              这些积分记录了无数次陪伴就医、情绪疏导、技能传授的真实付出，
              却因为<strong style={{ color: "#f9a8d4" }}>平台的一个关停决定</strong>而可能归于消失。
            </p>
            <p style={s.originText}>
              HerTime 用智能合约解决这个根本问题：时间 Token 存在你自己的钱包，
              不经过任何平台账户，声誉记录写在链上永不消失。
              平台可以倒闭，但你帮助过别人的证明将永远存在。
            </p>
          </div>
        </div>
      </section>
